...
const Plate = ({immat, postalCode}) => {
    return (
        <div className="w-full h-full m-0 p-0 rounded-lg flex justify-between items-center bg-gradient-to-tr from-white to-stone-200 overflow-hidden box-border">
            ...
            <div className="flex justify-center items-center w-full px-2 text-[200%] sm:text-[200%] font-chakra ">
                {immat}
            </div>
