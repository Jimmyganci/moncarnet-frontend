...
const HomeAppointment = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full pb-5 lg:-mt-20">
      ...
      <div className="flex flex-col items-center justify-center w-11/12 lg:h-4/6 lg:ml-20 lg:flex-row lg:justify-around">
        <div
          ...
          <div className="flex flex-col items-center justify-around">
            ...
            {infosAppointments.length !== 0 &&
              ...
              infosAppointments
                ...
                /* .slice(1, infosAppointments.length - 1) */
                .map((appointment, index: number) => (
                  <div
                    key={index}
      ...
      <div className='text-md font-inter max-w-md mb-2 w-[60%] flex justify-center'><ReturnButton target={''}/></div>
    </div>
  );
};
